...
@app.route('/usuario/<int:id>/servicios', methods = ['POST'])
@requiere_token
@recurso_usuario
def crear_servicio(id):
...
@app.route('/usuario/<int:id>/servicios/<int:id_serv>', methods = ['PUT'])
@requiere_token
@recurso_usuario
def modificar_servicio(id,id_serv):
    datos = request.get_json()
    datos["id_usuario"] = id
    try:
...
@app.route('/usuario/<int:id>/servicios/<int:id_servicio>', methods = ['DELETE'])
@requiere_token
@recurso_usuario
def eliminar_usuario(id,id_servicio):
    try:
        eliminar = Servicios.eliminar_servicio(id,id_servicio)
